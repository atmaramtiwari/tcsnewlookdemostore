 ...
 *
 */
package com.tcs.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms
		{
			...
			String ProductCompareComponent = _Prefix + ProductCompareComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String ComparePage = "pages/compare/productComparePage";
			}
		}
