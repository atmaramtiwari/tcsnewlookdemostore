 ...
 *
 */
package com.tcs.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("newlookcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("newlookcockpits.product.externalTaxes"));
