 ...
 *
 */
package com.tcs.cockpits.setup;
...
import com.tcs.cockpits.constants.NewlookCockpitsConstants;
 ...
 */
@SystemSetup(extension = NewlookCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(NewlookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(NewlookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						NewlookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/newlookcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
