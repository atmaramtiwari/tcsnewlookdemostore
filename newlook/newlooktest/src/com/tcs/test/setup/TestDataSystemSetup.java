...
import com.tcs.test.constants.NewlookTestConstants;
import com.tcs.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NewlookTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/newlooktest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/newlooktest/import/reviews.impex");
			...
			importImpexFile(context, "/newlooktest/import/cstickets.impex");
		}
	}
}
