 ...
 *
 */
package com.tcs.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(NewlookFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NewlookFulfilmentProcessConstants.PARENT_PROCESS);
